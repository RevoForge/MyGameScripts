...
public class TrollAI : MonoBehaviour, IMonsterAI, IPlayerDetectionAI
{
    ...
    private bool CanPerformAction()
    {
        ...
        bool isAttacking = currentState.IsName("Attack(1)") || currentState.IsName("Attack(2)") || currentState.IsName("Attack(3)");
